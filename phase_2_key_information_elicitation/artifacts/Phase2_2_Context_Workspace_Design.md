...
1. **Promotion mechanism (critical):**

   * What qualifies a pattern as “validated across cases”?
   * Manual SME approval vs automated detection?

2. **Variable normalization strategy:**

   * Where does normalization logic live (rules vs mappings vs embeddings)?

3. **Granularity of topic-variable patterns:**

   * Broad domains (e.g., drought) vs sub-problems (e.g., agricultural drought vs hydrological drought)

4. **Dataset family knowledge:**

   * Should common dataset families (e.g., MODIS, SMAP) get their own reusable context?

5. **Session memory boundaries:**

   * How long should preference context persist?

---

## Final Alignment

This workspace achieves your stated balance:

* **Minimal default loading**
* **Strong trigger-based activation**
